...
export const fetchGetScheduleList = async () => {
  try {
    const res = await api.get("/api/schedule/schedules/");
...
export const fetchPostSchedule = async (
  ...
  try {
    const res = await api.post("/api/schedule/schedules/", newSchedule);
...
export const fetchGetDetailSchedules = async (schedulesId) => {
  try {
    const res = await api.get(`/api/schedule/schedules/${schedulesId}/`);
...
export const fetchPutSchedules = async (
  ...
  try {
    const res = await api.put(
      `/api/schedule/schedules/${schedulesId}/`,
      updateSchedule
    );
...
export const fetchPutDetailSchedule = async (
  ...
  try {
    const res = await api.put(
      `/api/schedule/detail-schedules/${detailScheduleId}/`,
      newDetailSchedule
    );
...
export const fetchDeleteSchedules = async (schedulesId) => {
  try {
    const res = await api.delete(`/api/schedule/schedules/${schedulesId}/`);
